    ...
    public partial class TaskListFrm : BaseFrm
    {
        ...
        private void fillGridRowData(List<TaskEntity> list)
        {
            ...
            foreach (TaskEntity task in list)
            {
                ...
                row.Cells["PosTypes"].Tag = (int)task.PosTypes;
                row.Cells["PosTypes"].Value = task.PosTypes.ToString();                
        ...
        private void dgvTaskList_RowStateChanged(object sender, DataGridViewRowStateChangedEventArgs e)
        {
