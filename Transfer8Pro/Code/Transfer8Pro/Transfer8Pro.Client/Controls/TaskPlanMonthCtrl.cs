...
namespace Transfer8Pro.Client.Controls
{
    public partial class TaskPlanMonthCtrl : UserControl, ITaskPlanBase
    {
        ...
        {
            chklstMonths.SelectedIndexChanged -= chklstMonths_SelectedIndexChanged;
            cbxHour.SelectedIndexChanged -= cbxHour_SelectedIndexChanged;
            cbxMinute.SelectedIndexChanged -= cbxMinute_SelectedIndexChanged;
